...
//                                 _fb: "xpath_one",
//                                 _args: [
//                                     `.//span[contains(@class, 'f6431b446c fbfd7c1165 e84eb961f')]/text()`
//                                 ]
//                             }
//                         ]
//                     },
...
export async function fetchResults(searchParams: SearchParams) {
    ...
    if (!username || !password) {
        throw new Error("Oxylabs credentials are missing in environment variables.");
    }
            ...
            listings: {
                ...
                _items: {
                    ...
                    price: {
                        _fns: [
                            {
                                _fn: "xpath_one", // FIXED `_fb` to `_fn`
                                _args: [".//span[contains(@class, 'f6431b446c fbfd7c1165 e84eb961f')]/text()"]
                            }
                        ]
                    },
                    url: {
