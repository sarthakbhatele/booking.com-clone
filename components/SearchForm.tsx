                                ...
                                <Popover>
                                    ...
                                    <PopoverContent className="w-auto p-0" align="start">
                                        <Calendar initialFocus
                                            mode="range" selected={field.value} defaultMonth={field.value.from}
                                            onSelect={field.onChange} numberOfMonths={2} disabled={(date) => date < new Date(new Date().setHours(0, 0, 0, 0))}
                                        />
                                    </PopoverContent>
                                </Popover>
                            </FormItem>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    ...
                                    <FormMessage />
                                    <FormControl>
                                        <Input type="number" placeholder="Adults" className="bg-white" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-col">
                                    ...
                                    <FormMessage />
                                    <FormControl>
                                        <Input type="number" placeholder="Children" className="bg-white" {...field} />
                                    </FormControl>
                                </FormItem>
                            )}
                        />
